...
const Music4 = ({ navigation }) => {

  const [sound, setSound] = React.useState();

  async function playSound() {
    console.log('Loading Sound');
    const { sound } = await Audio.Sound.createAsync( require('../assets/GLITCHMODE.mp3')
    );
    setSound(sound);
      ...
      <View style={styles.detail}>
         ...
         <Text style={styles.memutar}>Sedang Memutar</Text>
            <Image
                ...
                source={require('../assets/GLITCHMODE.png')}
            />
        <Text style={styles.judulLagu}>Glitch Mode</Text>
